...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            <i class="fa fa-user text-warning"></i> Carlos Ugaz Arenas
          </a>
    ...
    <aside class="main-sidebar sidebar-dark-blue elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="{{asset('assets/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
        <span class="brand-text font-weight-light">EXAMEN</span>
      </a>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2023 <a href="https:incanatoit.com">IncanatoApps</a>.</strong> Derechos reservados.
    </footer>
  </div>
  <!-- ./wrapper -->
